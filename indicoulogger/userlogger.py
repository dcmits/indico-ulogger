...
class UserLogger():
    ...
    def __init__(self):
        ...
        # Do not rotate log file: /etc/logrotate.d/indico-log will take care of it
        stdout_hdlr = logging.handlers.RotatingFileHandler(filename=logFilePath_info, encoding='utf8')
